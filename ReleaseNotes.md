...
* BREAKING: [#11](https://github.com/Faithlife/FaithlifeTesting/issues/11)
  ...
  * Renamed `AssertEx.Builder<T>` to `Assertible<T>`
...
* Patch: [#9](https://github.com/Faithlife/FaithlifeTesting/issues/9) Imprive output when encountering indexers on captured lists.
